  ...
  return (
    <div className="App">
      <header className="App-header">
        <div class="aboutMe">
          ...
          {[...Array(8)].map((x, i) => {
            ...
            const calculateDurationRatio =
              ((100 - randomLeft) / 100) * randomDuration;
            return (
              <motion.div
                key={i}
                style={{
                ...
                transition={{
                  ease: "linear",
                  duration: calculateDurationRatio,
                  repeat: NaN,
                }}
              ></motion.div>
            );
          ...
          <div class="dirt">
            <span className="icons">
              ...
              <a
                href="mailto:themaxsmith@icloud.com"
                target="_blank"
                rel="noopener noreferrer"
              >
              ...
              {/* github */}
              <a
                href="https://github.com/themaxsmith"
                target="_blank"
                rel="noopener noreferrer"
              >
                <i class="bi-github"></i>
        ...
        <div class="footer">
          <small>Website Created by Maxwell Smith</small>
          <br />
          {/* view on github (icon) */}
          Source Code on{" "}
          <a
            style={{ color: "grey" }}
            href="https://github.com/themaxsmith/MaxSmithResumeWebsite"
            target="_blank"
            rel="noopener noreferrer"
          >
