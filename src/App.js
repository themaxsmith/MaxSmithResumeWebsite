...
// Developed new features and maintained HyVee’s online grocery web & mobile e-commerce platform. An application that customers for Hy-Vee’s 245+ grocery retail locations can use to order groceries online to be picked up or delivered. Focused mainly on the product detail page and product search results optimizations. 
...
// Individually created the NFC encoding process and developed the shared library that is used to read, service, and securely program the Polaris NFC emblem. The library is used by internal, retail, and consumer mobile apps. The NFC tag is located on all 2022 Polaris snowmobiles, RZR (UTV), and ATV product lines. 
// Used: C#, .Net Core, Android & iOS SDK in C#, Daily scrum, Dev Ops, CI/CD

// Polaris
// D&IS Software Developer Intern
// May 2020 - August 2020
// Medina, MN

// Developed new features & maintained the internal “Vehicle Inspection Application” used in Polaris manufacturing plants worldwide (mobile app, backend API, shared library). The app is used to track manufacturing progress, report vehicle issues, and inspection of vehicle parts. Focused on manufacturing of motorcycles, snowmobiles, and UTV vehicles
